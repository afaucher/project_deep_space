...
func _init() -> void:
	ship_tier = ComponentSpec.Tier.UNVALIDATED
	max_speed = 0.0
	max_omega = 0.0
	...
	ship_components = [
		...
		{"id": "comms", "type": "comms", "rect": Rect2(-2.5, 2.5, 5.0, 5.0), "health": 20.0, "max_health": 20.0, "density": 20.0, "range": 50000.0, "transponder_custom_name": "Nav Buoy"},
		...
		{"id": "rcs_fwd", "type": "rcs", "rect": Rect2(2.5, -2.5, 5.0, 5.0), "health": 50.0, "max_health": 50.0, "density": 20.0, "thrust_rating": 1000.0, "torque_rating": 1000.0},
	]
	super()
