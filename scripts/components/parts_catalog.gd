...
const PARTS := {
	...
	"missile": {
		ComponentSpec.Tier.DRONE: {
			Mark.COMPACT:  {"range": 6000.0,  "cooldown_max": 8.0, "ammo": 2, "size": Vector2(3, 3)},
			Mark.STANDARD: {"range": 10000.0, "cooldown_max": 5.0, "ammo": 4, "size": Vector2(4, 4)},
			Mark.HEAVY:    {"range": 16000.0, "cooldown_max": 3.0, "ammo": 6, "size": Vector2(5, 6)},
		},
		ComponentSpec.Tier.LIGHT: {
			Mark.COMPACT:  {"range": 11000.0, "cooldown_max": 8.0, "ammo": 3, "size": Vector2(4, 4)},
			Mark.STANDARD: {"range": 12000.0, "cooldown_max": 6.0, "ammo": 4, "size": Vector2(5, 5)},
			Mark.HEAVY:    {"range": 22000.0, "cooldown_max": 3.5, "ammo": 6, "size": Vector2(5, 8)},
		},
		ComponentSpec.Tier.MEDIUM: {
			Mark.COMPACT:  {"range": 21000.0, "cooldown_max": 7.0, "ammo": 4,  "size": Vector2(5, 6)},
			Mark.STANDARD: {"range": 28000.0, "cooldown_max": 5.0, "ammo": 5,  "size": Vector2(5, 15)},
			Mark.HEAVY:    {"range": 38000.0, "cooldown_max": 3.0, "ammo": 8,  "size": Vector2(8, 18)},
		},
		ComponentSpec.Tier.HEAVY: {
			Mark.COMPACT:  {"range": 29000.0, "cooldown_max": 7.0, "ammo": 6,  "size": Vector2(5, 12)},
			Mark.STANDARD: {"range": 40000.0, "cooldown_max": 5.0, "ammo": 8,  "size": Vector2(8, 18)},
			Mark.HEAVY:    {"range": 58000.0, "cooldown_max": 2.5, "ammo": 12, "size": Vector2(10, 24)},
		},
		ComponentSpec.Tier.STRUCTURE: {
			Mark.COMPACT:  {"range": 21000.0, "cooldown_max": 7.0, "ammo": 6,  "size": Vector2(5, 12)},
			Mark.STANDARD: {"range": 35000.0, "cooldown_max": 5.0, "ammo": 10, "size": Vector2(8, 18)},
			Mark.HEAVY:    {"range": 58000.0, "cooldown_max": 2.5, "ammo": 16, "size": Vector2(10, 24)},
		},
	},
	"engine": {
		ComponentSpec.Tier.DRONE: {
